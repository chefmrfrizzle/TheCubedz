...
async function build() {
  ...
  const [candidate, result, coordinateCandidate, coordinateResult, benchmark, crosscheck, coordinateCrosscheck, passport, review, graph, agents, roadmap, program] = await Promise.all([
